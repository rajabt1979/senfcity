	...
	<div class="card card-info">
		...
		<div class="card-body">
	          	...
	          	<div class="col-md-6">
					...
					<br>
	          		<div class="form-group">
						...
						<?php 
							echo form_input( array(
								'disabled' => $this->config->item("is_demo") == 1 ? 'disabled' : '' ,
								'type' => 'text',
	        ...
	        <div class="col-md-6">
				...
				<input class="form-control" <?php echo $this->config->item("is_demo") == 1 ? 'disabled' : '' ?> type="text" placeholder="<?php echo get_msg('paystack_key_label')?>" name='paystack_key' id='paystack_key'
