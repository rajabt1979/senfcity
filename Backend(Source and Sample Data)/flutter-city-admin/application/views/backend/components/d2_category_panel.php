                ...
                <?php foreach($data as $d): ?>
                    <li class="item">
                        <div class="product-img">
                            <?php $default_photo = get_default_photo( $d->id, 'category' ); ?>
...
<?php 
    ...
    if ($permission_data_count > 0) {
      ...
      //get module id
      $conds_moudle['module_name'] = "categories";
      ...
      if ($allowed_module_data->is_empty_object == 0) { ?>
        ...
        <div class="card-footer text-center">
          <a href="<?php echo site_url('admin/categories'); ?>"><?php echo get_msg('view_all_cats'); ?></a>
        </div>
        <!-- /.card-footer -->
      <?php } ?>
    <?php } else { ?>  
