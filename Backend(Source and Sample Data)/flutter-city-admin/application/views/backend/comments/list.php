		...
		<?php foreach($comments->result() as $comm): ?>
			...
			<tr>
				...
				<td><?php 
					...
					?>
					<?php
						echo "<p class= 'text-center' style='padding: 0 50px'>$comm->added_date</p>";
					?>
				</td>
			
				<td>
					<a class="pull-right btn btn-sm btn-primary" href="<?php echo $module_site_url .'/edit/'. $comm->id; ?>" aria-expanded="true" aria-controls="collapseOne" style="margin-right: 170px;">
								<?php echo "<medium style='padding: 0 70px'>" . $detail_count . " Reply </medium>"; ?>
					</a>
				</td>
