...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/backend/css/style.css'); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url( 'assets/plugins/timepicker/jquery.ptTimeSelect.css' ); ?>" />
	<script type="text/javascript" src="<?php echo base_url( 'assets/plugins/timepicker/jquery.ptTimeSelect.js' ); ?>"></script>
