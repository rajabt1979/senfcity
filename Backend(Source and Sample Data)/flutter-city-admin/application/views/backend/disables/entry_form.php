    ...
    <form role="form">
        <div class="card-body">
          <div class="row">
            ...
            <?php echo form_input( array(
              'name' => 'name',
              'value' => set_value( 'name', show_data( @$disable->name), false ),
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              ...
              'value' => set_value( 'info', show_data( @$disable->highlight_information), false ),
              'class' => 'form-control form-control-sm',
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'description',
              'value' => set_value( 'desc', show_data( @$disable->description), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_input( array(
              'name' => 'search_tag',
              'value' => set_value( 'search_tag', show_data( @$disable->search_tag), false ),
              'class' => 'form-control form-control-sm',
          ...
          <div class="form-group">
            <div class="form-check">
              ...
              <?php echo form_checkbox( array(
                ...
                'id' => 'is_featured',
                'value' => 'accept',
                'checked' => set_checkbox('is_featured', 1, ( @$disable->is_featured == 1 )? true: false ),
          ...
          <div class="form-group">
            <div class="form-check">
              ...
              <?php echo form_checkbox( array(
                ...
                'id' => 'is_promotion',
                'value' => 'accept',
                'checked' => set_checkbox('is_promotion', 1, ( @$disable->is_promotion == 1 )? true: false ),
                'class' => 'form-check-input',
                'onclick' => 'return false'
              )); ?>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group" id="sample1">
            ...
            <br>
            <input id="timestart" type="text" name="opening_hour" value="<?php echo $disable->opening_hour; ?>" style="width: 50%;" disabled/>
            <br><br>
            <label>
              Close time:
            </label>
            <br>
            <input type="text" id="time_end" name="closing_hour" value="<?php echo $disable->closing_hour; ?>"  style="width: 50%;" disabled/>
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'time_remark',
              'value' => set_value( 'time_remark', show_data( @$disable->time_remark), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_input( array(
              'name' => 'phone1',
              'value' => set_value( 'phone1', show_data( @$disable->phone1), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_input( array(
              'name' => 'phone2',
              'value' => set_value( 'phone2', show_data( @$disable->phone2), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_input( array(
              'name' => 'phone3',
              'value' => set_value( 'phone3', show_data( @$disable->phone3), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_input( array(
              'name' => 'email',
              'value' => set_value( 'email', show_data( @$disable->email), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'facebook',
              'value' => set_value( 'facebook', show_data( @$disable->facebook), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'google_plus',
              'value' => set_value( 'google_plus', show_data( @$disable->google_plus), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'twitter',
              'value' => set_value( 'twitter', show_data( @$disable->twitter), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'youtube',
              'value' => set_value( 'youtube', show_data( @$disable->youtube), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'instagram',
              'value' => set_value( 'instagram', show_data( @$disable->instagram), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'pinterest',
              'value' => set_value( 'pinterest', show_data( @$disable->pinterest), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'website',
              'value' => set_value( 'website', show_data( @$disable->website), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'whatsapp',
              'value' => set_value( 'whatsapp', show_data( @$disable->whatsapp), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'messenger',
              'value' => set_value( 'messenger', show_data( @$disable->messenger), false ),
              'class' => 'form-control form-control-sm',
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              'name' => 'terms',
              'value' => set_value( 'terms', show_data( @$disable->terms), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              ...
              'value' => set_value( 'cancelation_policy', show_data( @$disable->cancelation_policy), false ),
              'class' => 'form-control form-control-sm',
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <?php echo form_textarea( array(
              ...
              'value' => set_value( 'additional_info', show_data( @$disable->additional_info), false ),
              'class' => 'form-control form-control-sm',
      ...
      <?php if ( isset( $disable )){ ?>
        ...
        <?php 
          ...
          $spec_data = $this->Specification->get_all_by( array( 'item_id' => @$disable->id ))->result(); 
