...
class FavouriteItem extends PsMapObject<FavouriteItem> {
  ...
  @override
  bool operator ==(dynamic other) => other is FavouriteItem && id == other.id;
  ...
  @override
  FavouriteItem fromMap(dynamic dynamicData) {
    //if (dynamicData != null) {
  ...
  @override
  List<FavouriteItem> fromMapList(List<dynamic> dynamicDataList) {
    final List<FavouriteItem> favouriteProductMapList = <FavouriteItem>[];
