                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          if (paidAdItem.paidStatus == PsConst.PAID_AD_PROGRESS)
                            Text(Utils.getString('paid_ad__sponsor'),
                                textAlign: TextAlign.start,
                  ...
                  Positioned(
                      ...
                      child: (paidAdItem.paidStatus == PsConst.ADSPROGRESS)
                          ? Container(
                              ...
                              child: Text(
                                Utils.getString('paid__ads_in_progress'),
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyText1!
                          ...
                          : (paidAdItem.paidStatus == PsConst.ADSFINISHED)
                              ? Container(
                                  ...
                                  child: Text(
                                    Utils.getString('paid__ads_in_completed'),
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText1!
                                        .copyWith(color: Colors.white),
                ...
                children: <Widget>[
                  ...
                  Container(
                      margin: const EdgeInsets.only(
                          left: PsDimens.space8, right: PsDimens.space8),
                      child: Text(Utils.getString('profile__start_date'),
                          textAlign: TextAlign.start,
                          style: Theme.of(context)
                              .textTheme
                              .caption!
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: Text(Utils.getString('profile__end_date'),
                          textAlign: TextAlign.start,
                          style: Theme.of(context)
                              .textTheme
                              .caption!
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Padding(
                          padding: const EdgeInsets.only(
                              left: PsDimens.space8, right: PsDimens.space4),
                          child: Text(Utils.getString('profile__amount'),
                              textAlign: TextAlign.start,
                              style: Theme.of(context)
                                  .textTheme
                                  .caption!
