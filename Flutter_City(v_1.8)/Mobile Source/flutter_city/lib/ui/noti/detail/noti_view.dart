...
import 'package:fluttercity/provider/noti/noti_provider.dart';
...
import 'package:fluttercity/viewobject/holder/noti_post_parameter_holder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: PsWidgetWithAppBar<NotiProvider>(
            appBarTitle: Utils.getString('noti__toolbar_name') ,
            initProvider: () {
              return NotiProvider(
