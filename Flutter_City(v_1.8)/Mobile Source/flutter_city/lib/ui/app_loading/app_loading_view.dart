...
import 'package:fluttercity/provider/clear_all/clear_all_data_provider.dart';
...
import 'package:fluttercity/ui/common/dialog/version_update_dialog.dart';
...
import 'package:fluttercity/viewobject/holder/app_info_parameter_holder.dart';
  ...
  Future<dynamic> callDateFunction(AppInfoProvider provider,
    ...
    if (await Utils.checkInternetConnectivity()) {
      ...
      if (_psAppInfo.status == PsStatus.SUCCESS) {
        ...
        print(Utils.getString('app_info__cancel_button_name'));
        print(Utils.getString('app_info__update_button_name'));
        ...
        if (_psAppInfo.data!.userInfo!.userStatus == PsConst.USER_BANNED) {
          ...
          showDialog<dynamic>(
              ...
              builder: (BuildContext context) {
                return WarningDialog(
                  message: Utils.getString('user_status__banned'),
                  onPressed: () {
          ...
          showDialog<dynamic>(
              ...
              builder: (BuildContext context) {
                return WarningDialog(
                  message: Utils.getString('user_status__deleted'),
                  onPressed: () {
                    checkVersionNumber(context, _psAppInfo.data!, provider,
                        clearAllDataProvider!);
                    realStartDate = realEndDate;
          ...
          showDialog<dynamic>(
              ...
              builder: (BuildContext context) {
                return WarningDialog(
                  message: Utils.getString('user_status__unpublished'),
                  onPressed: () {
                    checkVersionNumber(context, _psAppInfo.data!, provider,
                        clearAllDataProvider!);
                    realStartDate = realEndDate;
    ...
    showDialog<dynamic>(
        ...
        builder: (BuildContext context) {
          return VersionUpdateDialog(
                ...
                leftButtonText: Utils.getString('app_info__cancel_button_name'),
                rightButtonText:
                    Utils.getString('app_info__update_button_name'),
                onCancelTap: () {
                  final PsValueHolder? valueHolder =
                      Provider.of<PsValueHolder?>(context, listen: false);
                  ...
                  children: <Widget>[
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          Utils.getString('app_info__splash_name'),
