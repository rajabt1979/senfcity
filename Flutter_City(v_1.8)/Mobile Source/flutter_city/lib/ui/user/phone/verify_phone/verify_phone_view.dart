...
import 'package:fluttercity/viewobject/holder/phone_login_parameter_holder.dart';
import 'package:fluttercity/viewobject/holder/resend_code_holder.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                          child: Text(
                            Utils.getString('phone_signin__back_login'),
...
dynamic callWarningDialog(BuildContext context, String text) {
  showDialog<dynamic>(
      ...
      builder: (BuildContext context) {
        return WarningDialog(message: Utils.getString(text), onPressed: () {});
      });
}
      ...
      children: <Widget>[
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintText: Utils.getString('email_verify__enter_verification_code'),
        ...
        Container(
          ...
          child: PSButtonWidget(
            ...
            titleText: Utils.getString('email_verify__submit'),
            onPressed: () async {
              if (codeController.text.isEmpty) {
                callWarningDialog(
                    context, Utils.getString('warning_dialog__code_require'));
                  ...
                  try {
                    ...
                    showDialog<dynamic>(
                        ...
                        builder: (BuildContext context) {
                          return ErrorDialog(
                            message:
                                Utils.getString('error_dialog__code_wrong'),
                          );
                        });
                  }
                }
        ...
        Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                Text(
                  Utils.getString('phone_signin__title1'),
                  textAlign: TextAlign.center,
                  style: Theme.of(context)
                      .textTheme
                      .bodyText2!
    ...
    return Row(
      ...
      children: <Widget>[
        MaterialButton(
          ...
          height: 40,
          child: Text(Utils.getString('email_verify__change_email')),
        ...
        MaterialButton(
          ...
          highlightColor: PsColors.transparent,
          height: 40,
          child: Text(Utils.getString('email_verify__resent_code')),
          textColor: PsColors.mainColor,
          onPressed: () async {
            if (await Utils.checkInternetConnectivity()) {
                ...
                showDialog<dynamic>(
                    ...
                    builder: (BuildContext context) {
                      return SuccessDialog(
                          message: _apiStatus.data!.message, onPressed: () {});
                    });
              } else {
                showDialog<dynamic>(
                    context: context,
