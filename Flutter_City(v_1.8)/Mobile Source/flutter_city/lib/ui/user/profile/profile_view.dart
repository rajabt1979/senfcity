...
import 'package:fluttercity/provider/item/disabled_item_provider.dart';
import 'package:fluttercity/provider/item/paid_ad_item_provider.dart';
import 'package:fluttercity/provider/item/pending_item_provider.dart';
import 'package:fluttercity/provider/item/rejected_item_provider.dart';
...
import 'package:fluttercity/ui/history/list/history_horizontal_list_view.dart';
import 'package:fluttercity/ui/items/item/item_horizontal_list_item.dart';
import 'package:fluttercity/ui/paid_ad/paid_ad_item_horizontal_list_item.dart';
    ...
    return Scaffold(
        ...
        body:
          ...
          _ListingDataWidget(
            ...
            headerTitle: Utils.getString('profile__listing'),
          ...
          _PendingListingDataWidget(
            ...
            headerTitle: Utils.getString('profile__pending_listing'),
          ...
          _RejectedListingDataWidget(
            ...
            headerTitle: Utils.getString('profile__rejected_listing'),
          ...
          _DisabledListingDataWidget(
            ...
            headerTitle: Utils.getString('profile__disable_listing'),
              ...
              return AnimatedBuilder(
                  ...
                  child: (itemProvider.paidAdItemList.data != null &&
                      ...
                      ? Column(children: <Widget>[
                          _HeaderWidget(
                            headerName: Utils.getString('profile__paid_ad'),
                            viewAllClicked: () {
                              Navigator.pushNamed(
                                context,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        _dividerWidget,
                        _FavAndSettingWidget(userProvider: provider,callLogoutCallBack:widget.callLogoutCallBack,),
                        _dividerWidget,
...
class _FavAndSettingWidget extends StatelessWidget {
  const _FavAndSettingWidget({this.userProvider,required this.callLogoutCallBack});
  final UserProvider? userProvider;
    final Function callLogoutCallBack;
  @override
  Widget build(BuildContext context) {
        ...
        child: MaterialButton(
            ...
            child: checkText == 0
                ...
                : checkText == 1
                    ...
                    : Text(
                        Utils.getString('profile__notification'),
                        softWrap: false,
                        style: Theme.of(context)
                            .textTheme
                            .bodyText2!
