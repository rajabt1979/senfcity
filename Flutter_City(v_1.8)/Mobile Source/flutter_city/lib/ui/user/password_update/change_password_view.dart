...
import 'package:fluttercity/viewobject/holder/change_password_holder.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialButton(
        ...
        child: provider != null
            ? provider!.isLoading
                ? Text(
                    Utils.getString('login__loading'),
                ...
                : Text(
                    Utils.getString('change_password__save'),
                    style: Theme.of(context)
                        .textTheme
                        .button!
                        .copyWith(color: Colors.white),
            ...
            : Text(
                Utils.getString('login__sign_in'),
                style: Theme.of(context)
                    .textTheme
                    .button!
                    .copyWith(color: Colors.white),
