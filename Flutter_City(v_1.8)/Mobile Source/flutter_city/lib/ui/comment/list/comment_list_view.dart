...
import 'package:fluttercity/provider/comment/comment_header_provider.dart';
...
import 'package:fluttercity/viewobject/holder/comment_header_holder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<CommentHeaderProvider>(
        appBarTitle: Utils.getString('comment_list__title') ,
        initProvider: () {
              ...
              children: <Widget>[
                ...
                Expanded(
                    ...
                    child: PsTextFieldWidget(
                      hintText: Utils.getString('comment_list__comment_hint'),
