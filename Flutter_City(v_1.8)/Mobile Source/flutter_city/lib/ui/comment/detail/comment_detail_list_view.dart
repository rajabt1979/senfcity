...
import 'package:fluttercity/provider/comment/comment_detail_provider.dart';
...
import 'package:fluttercity/viewobject/holder/comment_detail_holder.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: PsWidgetWithAppBar<CommentDetailProvider>(
        appBarTitle: Utils.getString('comment_detail__app_bar_name'),
        initProvider: () {
            ...
            children: <Widget>[
              ...
              Expanded(
                  ...
                  child: PsTextFieldWidget(
                    hintText: Utils.getString('comment_detail__comment_hint'),
                            ...
                            builder: (BuildContext context) {
                              return WarningDialog(
                                  message: Utils.getString(
                                      Utils.getString('comment__empty')),
                                  onPressed: () {});
                            });
                      } else {
                            ...
                            if (_apiStatus.data != null) {
                              ...
                              showDialog<dynamic>(
                                  ...
                                  builder: (BuildContext context) {
                                    return ErrorDialog(
                                      message: Utils.getString(
                                          Utils.getString(_apiStatus.message)),
                                    );
                                  });
                            }
                          });
