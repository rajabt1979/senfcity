...
import 'package:fluttercity/ui/blog/list/blog_list_view.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor:
              Utils.isLightMode(context) ? PsColors.mainColor : Colors.black87,
          title: Text(Utils.getString('blog_list__app_bar_name'),
