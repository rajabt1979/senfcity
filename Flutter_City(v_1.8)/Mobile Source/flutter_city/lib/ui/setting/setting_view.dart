...
import 'package:fluttercity/viewobject/holder/intent_holder/privacy_policy_intent_holder.dart';
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  Text(
                    Utils.getString( 'setting__app_info'),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        //   arguments: const TermsAndConditionIntentHolder(
        //       checkType: 4, description: ''),
        // );
          ...
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                ...
                Text(
                  Utils.getString( 'setting__policy_statement'),
                  style: Theme.of(context).textTheme.caption,
                ),
              ],
            ),
        ...
        child: Row(
          ...
          children: <Widget>[
            Column(
              ...
              children: <Widget>[
                Text(
                  Utils.getString( 'setting__notification_setting'),
                  style: Theme.of(context).textTheme.subtitle1,
                ),
                const SizedBox(
                  height: PsDimens.space10,
                ...
                Text(
                  Utils.getString( 'setting__control_setting'),
                  style: Theme.of(context).textTheme.caption,
                ),
              ],
            ),
          ...
          child: Row(
            ...
            children: <Widget>[
              Column(
                ...
                children: <Widget>[
                  Text(
                    Utils.getString( 'intro_slider_setting'),
                    style: Theme.of(context).textTheme.subtitle1,
                  ),
                  const SizedBox(
                    height: PsDimens.space10,
                  ...
                  Text(
                    Utils.getString( 'intro_slider_setting_description'),
                    style: Theme.of(context).textTheme.caption,
                  ),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              Utils.getString( 'setting__change_mode'),
              style: Theme.of(context).textTheme.subtitle1,
            ),
            if (checkClick)
              Switch(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              Utils.getString('setting__app_version'),
              style: Theme.of(context).textTheme.subtitle1,
            ),
            const SizedBox(
              height: PsDimens.space10,
