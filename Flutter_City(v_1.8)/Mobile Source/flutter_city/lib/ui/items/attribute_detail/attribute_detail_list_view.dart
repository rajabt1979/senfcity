...
import 'package:fluttercity/ui/items/attribute_detail/attribute_detail_list_item_view.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(Utils.getString('attribute_detail_list__app_bar_name'),
