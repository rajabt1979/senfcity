...
import 'package:fluttercity/ui/common/ps_credit_card_form_for_pay_stack.dart';
...
class PayStackViewState extends State<PayStackView> {
  ...
  Widget build(BuildContext context) {
    ...
    return PsWidgetWithAppBarWithNoProvider(
      appBarTitle: Utils.getString('item_promote__pay_stack'),
      child: Column(
        children: <Widget>[
          Expanded(
                    ...
                    onPressed: () async {
                      if (cardNumber.isEmpty) {
                        callWarningDialog(context,
                            Utils.getString('warning_dialog__input_number'));
                      } else if (expiryDate.isEmpty) {
                        callWarningDialog(context,
                            Utils.getString('warning_dialog__input_date'));
                        ...
                        callWarningDialog(context,
                            Utils.getString('warning_dialog__input_cvv'));
                      } else {
