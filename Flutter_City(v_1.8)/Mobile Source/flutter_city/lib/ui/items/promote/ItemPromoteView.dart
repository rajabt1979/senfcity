...
import 'package:fluttercity/provider/token/token_provider.dart';
...
import 'package:fluttercity/ui/common/dialog/demo_warning_dialog.dart';
      ...
      child: MultiProvider(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              Utils.getString('item_promote__entry'),
            ...
            children: <Widget>[
              Padding(
                ...
                child: PsDropdownBaseWithControllerWidget(
                    title: Utils.getString('item_promote__ads_start_date'),
  ...
  Widget build(BuildContext context) {
    final Widget payStackButtonWidget = Container(
      ...
      child: PSButtonWithIconWidget(
          ...
          titleText: Utils.getString('item_promote__pay_stack'),
            ...
            if (provider!.selectedDate == '' || provider.selectedDate == null) {
              ...
              if (provider != null) {
                final dynamic returnData = await Navigator.pushNamed(
                    context, RoutePaths.payStackRequest,
    ...
    final Widget paypalButtonWidget = Container(
      ...
      child: PSButtonWithIconWidget(
          ...
          titleText: Utils.getString('item_promote__paypal'),
          onPressed: () async {
    ...
    final Widget stripeButtonWidget = Container(
      ...
      child: PSButtonWithIconWidget(
          ...
          titleText: Utils.getString('item_promote__stripe'),
          colorData: PsColors.stripeColor,
          onPressed: () async {
            if (double.parse(amount!) <= 0) {
              return;
    ...
    final Widget razorButtonWidget = Container(
      ...
      child: PSButtonWithIconWidget(
          ...
          width: double.infinity,
          colorData: PsColors.paypalColor,
          titleText: Utils.getString('item_promote__razor'),
          onPressed: () async {
            if (double.parse(amount!) <= 0) {
              return;
            }
            ...
            void _handlePaymentError(PaymentFailureResponse response) {
              ...
              showDialog<dynamic>(
                  ...
                  builder: (BuildContext context) {
                    return ErrorDialog(
                      message: Utils.getString('checkout__payment_fail'),
                    );
                  });
            }
            ...
            void _handleExternalWallet(ExternalWalletResponse response) {
              ...
              showDialog<dynamic>(
                  ...
                  builder: (BuildContext context) {
                    return ErrorDialog(
                      message:
                          Utils.getString('checkout__payment_not_supported'),
                    );
                  });
            }
                            ...
                            children: <Widget>[
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(Utils.getString(currencySymbol) +
                              ...
                              Padding(
                                ...
                                child: Text(PsConfig
                                        .PROMOTE_FIRST_CHOICE_DAY_OR_DEFAULT_DAY +
                                    Utils.getString('item_promote__days')),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Column(
                                ...
                                children: <Widget>[
                                  Text(
                                      Utils.getString('item_promote__customs')),
                                  if (getEnterDateCountController.text != '' &&
