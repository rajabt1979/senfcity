...
class ChoosePaymentVIew extends StatefulWidget {
  const ChoosePaymentVIew(
      {Key? key, required this.item, required this.appInfo})
      : super(key: key);
      ...
      child: Consumer<UserProvider>(
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text(
              Utils.getString('pesapal_payment__title'),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    Utils.getString('item_promote__choose_payment'),
                ...
                Container(
                    ...
                    child: PSButtonWidget(
                      ...
                      titleText:
                          Utils.getString('item_promote__in_app_purchase'),
                      onPressed: () async {
                        // InAppPurchase View
