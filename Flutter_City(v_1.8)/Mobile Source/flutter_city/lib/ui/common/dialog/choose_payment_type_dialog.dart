...
import 'package:fluttercity/ui/common/dialog/ps_button_widget_with_round_corner.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(Utils.getString('pesapal_payment__title'),
            ...
            PSButtonWidgetRoundCorner(
              ...
              titleText: Utils.getString('item_promote__in_app_purchase'),
              onPressed: () async {
            ...
            PSButtonWidgetRoundCorner(
              hasShadow: true,
              width: double.infinity,
              titleText: Utils.getString('item_promote__other'),
              onPressed: () async {
                Navigator.pop(context);
