  ...
  Future<LaunchStoreResult> launchStore() async {
    if (Platform.isIOS) {
      final int? result = await _channel.invokeMethod(
        'launchStore',
        // ignore: always_specify_types
        appStoreIdentifier == null ? null : {'appId': appStoreIdentifier},
      );
      switch (result) {
        case 0:
          return LaunchStoreResult.storeOpened;
      ...
      // Replace 'com.senfcity.app' with the package name of your app.
      const String cafeBazaarUrl = 'https://cafebazaar.ir/app/com.senfcity.app';
      final bool launched = await launchUrl(Uri.parse(cafeBazaarUrl)); // Use launchUrl instead of launch
      return launched ? LaunchStoreResult.storeOpened : LaunchStoreResult.errorOccurred;
    } else {
      return LaunchStoreResult.errorOccurred;
    }
  }
