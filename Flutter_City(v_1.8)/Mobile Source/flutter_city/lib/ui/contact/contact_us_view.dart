...
import 'package:fluttercity/provider/contact/contact_us_provider.dart';
...
import 'package:fluttercity/viewobject/holder/contact_us_holder.dart';
              ...
              if (_apiStatus.data != null) {
                ...
                showDialog<dynamic>(
                    ...
                    builder: (BuildContext context) {
                      if (_apiStatus.data!.status == 'ارسال موفق !') {
