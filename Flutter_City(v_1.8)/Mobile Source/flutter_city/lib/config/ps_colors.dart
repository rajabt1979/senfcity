...
class PsColors {
  ...
  /// Common Theme
  ///
  static const Color _c_main_color = Color(0xFFC81D11);
  static const Color _c_main_light_color = Color(0xFFD8F2FF);
  static const Color _c_main_dark_color = Color(0xFF701C1C);
