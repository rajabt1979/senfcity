...
import 'package:fluttercity/viewobject/holder/apple_login_parameter_holder.dart';
import 'package:fluttercity/viewobject/holder/facebook_login_user_holder.dart';
import 'package:fluttercity/viewobject/holder/fb_login_parameter_holder.dart';
import 'package:fluttercity/viewobject/holder/google_login_parameter_holder.dart';
import 'package:fluttercity/viewobject/holder/user_login_parameter_holder.dart';
import 'package:fluttercity/viewobject/holder/user_register_parameter_holder.dart';
      ...
      showDialog<dynamic>(
          ...
          builder: (BuildContext context) {
            return WarningDialog(
                message: '[ $email ]\n' +
                    Utils.getString(Utils.getString('auth__email_provider')),
                onPressed: () {});
          });
    }
    // Registered With Google
      ...
      showDialog<dynamic>(
          ...
          builder: (BuildContext context) {
            return WarningDialog(
                message: '[ $email ]\n' +
                    Utils.getString(Utils.getString('auth__google_provider')),
                onPressed: () {});
          });
    }
    // Registered With Facebook
      ...
      showDialog<dynamic>(
          ...
          builder: (BuildContext context) {
            return WarningDialog(
                message: '[ $email ]\n' +
                    Utils.getString(Utils.getString('auth__facebook_provider')),
                onPressed: () {});
          });
    }
    // Registered With Apple
      ...
      showDialog<dynamic>(
          ...
          builder: (BuildContext context) {
            return WarningDialog(
                message: '[ $email ]\n' +
                    Utils.getString(Utils.getString('auth__apple_provider')),
                onPressed: () {});
          });
    }
  }
